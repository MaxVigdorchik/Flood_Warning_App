...
import org.maxvigdorchik.floodwarning.StationFragment.OnListFragmentInteractionListener;
import org.maxvigdorchik.floodwarning.dummy.DummyContent.DummyItem;
...
public class MyStationRecyclerViewAdapter extends RecyclerView.Adapter<MyStationRecyclerViewAdapter.ViewHolder>
{
    ...
    public void onBindViewHolder(final ViewHolder holder, int position)
    {
        ...
        holder.mContentView.setText(mValues.get(position).risk);
